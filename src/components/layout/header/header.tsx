        ...
        if (isAuthorizing) {
            ...
            return (
                <>
                    ...
                    <AccountSwitcher activeAccount={{ ...activeAccount, loginid: swapped_loginid }} />
                    {isDesktop &&
                        (has_wallet ? (
                            <Button
